                        ...
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-lg-6 text-start text-white">
                                    <h6 class="text-black">Edit Role</h6>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="name" name="name" type="text" class="form-control form-control-lg" value="{{ old('name', $role->name) }}" required autofocus autocomplete="name" />
                                                        @if ($errors->has('name'))
